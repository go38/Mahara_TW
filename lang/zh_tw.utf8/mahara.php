...
$string['accesstotallydenied_institutionsuspended'] = '您所屬的機構 %s 已經被暫時停用。除非取消停用，否則您無法登入%s 。<br />請聯繫您所屬的機構尋求協助。';
$string['account'] = '我的帳戶';
...
$string['cannotremovedefaultemail'] = '你不能刪除你的主要電子郵件地址';
...
$string['enable'] = '啟用';
$string['errorprocessingform'] = '提交此表格時出現錯誤。 請檢查已標記的欄位並且再試一次。';
$string['expand'] = '展開';
...
$string['formatpostbbcode'] = '你可使用BBCode更改文章格式。 %s學習更多%s';
...
$string['javascriptnotenabled'] = '您的瀏覽器沒有啟用javascript， 您要登入Mahara前，需要先啟用 javascript。';
...
$string['logout'] = '登出';
$string['lostusernamepassword'] = '遺失帳號/密碼';
...
$string['organisedescription'] = '組織您的歷程檔案成為<a href="%s">頁面</a>，您可以選擇包含那些元素，為不同觀眾建立不同的頁面。';
...
$string['profileimage'] = '個人簡介圖片';
$string['publishablog'] = '發表一篇<a href="%s">部落格</a>文章';
$string['pwchangerequestsent'] = '你會立刻收到包含連結的電郵, 你可透過連結更改帳戶密碼。';
$string['quarantinedirname'] = '隔離';
$string['query'] = '查詢';
$string['querydescription'] = '用以搜尋的字';
$string['quota'] = '限額';
$string['quotausage'] = '已使用 <span id="quota_total">%s</span>（您有<span id="quota_used">%s</span> 容量額度）';
