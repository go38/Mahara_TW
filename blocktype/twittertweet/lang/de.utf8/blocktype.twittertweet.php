...
$string['title'] = 'Twittern-Button';
$string['description'] = 'Fügt den Twitter Twittern-Button hinzu.';

$string['showtitle'] = 'Blocktitel anzeigen?';

$string['datacount'] = 'Layout Stil';
$string['datacountdesc'] = 'Legt die  Anzeige des Twittern-Buttons fest.';
$string['datacountnone'] = 'Ohne Zähler';
$string['datacounthorizontal'] = 'Horizontale Zähler';
$string['datacountvertical'] = 'Vertikale Zähler';
